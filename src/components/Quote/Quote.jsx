export const Quote = () => {
  return (
    <div className="relative pb-12 pt-12.5">
      <p className="font-AbrilFatface text-orangeBtn text-6xl text-center font-normal absolute top-3 left-1/2 -translate-x-1/2">
        “
      </p>
      <p className=" text-center max-w-48 text-wrap block mx-auto ">
