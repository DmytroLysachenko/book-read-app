    ...
    <>
      ...
      <div className="flex justify-evenly gap-7 bg-white px-8 py-2 mx-auto mt-2 w-70 shadow-counter">
        <div className="flex flex-col items-center justify-center ">
          <span className="block w-full font-OpenSans text-2xl text-center font-bold text-bgOverlay relative after:content-[':'] after:font-serif after:absolute after:-right-5 after:text-2xl after:font-bold after:text-bgOverlay">
            {days}
          </span>
